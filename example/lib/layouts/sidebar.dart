...
import 'package:flutter_jsx_example/pages/home_page.dart';
import 'package:flutter_jsx_example/pages/sandbox_page.dart';
import 'package:flutter_jsx_example/pages/typography_page.dart';
import 'package:flutter_jsx_example/pages/typography_performance.dart';
        ...
        children: <Widget>[
          ResponsiveContainer(
            ...
            children: <Widget>[
              ...
              ResponsiveRow(
                children: <Widget>[
                  Text('JSX', style: JSXTypography.h1.apply(color: Colors.white)),
                ],
              ),
              ResponsiveRow(
                children: <Widget>[
